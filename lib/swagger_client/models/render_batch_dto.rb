...
module SwaggerClient
  ...
  class RenderBatchDTO
    # The unique ID of the render batch.
    attr_accessor :batch_id

    # The current state of the render (Not rendering = 0, Rendering = 1, Completed rendering = 2, Cancelled = 3, Publishing = 4).
    attr_accessor :state

    # The name of the render batch.
    attr_accessor :batch_name

    # The render request items in the batch.
    ...
    def self.swagger_types
      {
        ...
        :'state' => :'Integer',
        :'batch_name' => :'String',
        :'request_items' => :'Array<RenderRequestDTO>'
      }
    end
    ...
    def hash
      [batch_id, state, batch_name, request_items].hash
    end
